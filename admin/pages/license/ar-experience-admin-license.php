    ...
    <div class="wrap">
        ...
        <form method="post">
            <table class="form-table">
                <tr>
                    <th scope="row"><label
                            for="license_key"><?php echo esc_html__('License key:', 'my-plugin'); ?></label></th>
        ...
        <a href="https://realitech.dev/"
           class="button button-primary"><?php echo esc_html__('Purchase License', 'my-plugin'); ?></a>
